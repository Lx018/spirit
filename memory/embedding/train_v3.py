...
parser.add_argument('-lr', '--learning_rate', type=float, default=4e-5, help='Learning rate for the optimizer.')
...
OUTPUT_PATH = f'output/triplet-b{args.batch_size}-lr{args.learning_rate}-e{args.epochs}'
